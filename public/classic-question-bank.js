const FAMILIES = [
  ...
  },
  {
    ...
    facts: [
      ...
      ["Alhambra", "the Alhambra", "Spain"], ["Borobudur", "Borobudur", "Indonesia"], ["Chichen Itza", "Chichén Itzá", "Mexico"], ["Moai", "the moai of Rapa Nui", "Chile"], ["Rock-Hewn Churches, Lalibela", "the rock-hewn churches of Lalibela", "Ethiopia"], ["Neuschwanstein Castle", "Neuschwanstein Castle", "Germany"],
      ...
      ["Nan Madol", "Nan Madol", "Micronesia"], ["Mesa Verde National Park", "the Mesa Verde cliff dwellings", "United States"], ["Skara Brae", "Skara Brae", "United Kingdom"], ["Göbekli Tepe", "Göbekli Tepe", "Turkey"], ["Aït Benhaddou", "Aït Benhaddou", "Morocco"], ["Meroë", "Meroë", "Sudan"],
    ],
  },
  {
    category: "Geography",
  ...
  },
  {
    ...
    facts: [
      ["Mona Lisa", "the Mona Lisa", "Leonardo da Vinci"], ["The Starry Night", "The Starry Night", "Vincent van Gogh"], ["Guernica (Picasso)", "Guernica", "Pablo Picasso"], ["The Great Wave off Kanagawa", "The Great Wave off Kanagawa", "Katsushika Hokusai"], ["Girl with a Pearl Earring", "Girl with a Pearl Earring", "Johannes Vermeer"], ["The Birth of Venus", "The Birth of Venus", "Sandro Botticelli"],
  ...
  },
  {
    ...
    facts: [
      ["Primary producer", "an organism that builds organic matter from inorganic sources", "Producer"], ["Consumer (food chain)", "an organism obtaining energy by eating other organisms", "Consumer"], ["Decomposer", "an organism breaking down dead material and wastes", "Decomposer"], ["Food web", "a network of interconnected feeding relationships", "Food web"], ["Habitat", "the physical environment in which an organism lives", "Habitat"], ["Ecological niche", "a species’ role and resource use within an ecosystem", "Ecological niche"],
