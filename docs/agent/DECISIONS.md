...
- Keep the authored trivia bank client-side so every question remains inspectable and can link directly to a Wikipedia research subject.
- Persist a 32-question most-recently-used history in the browser.
