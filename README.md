...
- The painted doors open onto the chambers actually to your left and right, and the keep is built so those two doors are always enough: no chamber is ever entered facing two blank walls, all one hundred are reachable without turning, and two doors are offered on 42% of entries. The route board draws the chambers you have walked with every opened seal marked on the edge between them
