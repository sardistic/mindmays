...
- The painted doors open onto the chambers actually to your left and right; turning by a quarter faces another wall, so every passage out of a chamber comes onto a door, and the route board draws the chambers you have walked with every opened seal marked on the edge between them
